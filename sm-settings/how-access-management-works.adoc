...
summary: 'Access Management est une méthode pour établir l"authentification des utilisateurs dans SANtricity System Manager. L"authentification exige que les utilisateurs se connectent à ces systèmes avec leurs informations d"identification attribuées.' 
---
