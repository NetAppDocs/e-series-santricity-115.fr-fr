...
* <<Étape 1 : téléchargez le fichier de métadonnées IDP,Étape 1 : téléchargez le fichier de métadonnées IDP>>
* <<Étape 2 : exporter les fichiers du fournisseur de services,Étape 2 : exporter les fichiers du fournisseur de services>>
* <<Étape 3 : rôles de carte,Étape 3 : rôles de carte>>
* <<Étape 4 : testez la connexion SSO,Étape 4 : testez la connexion SSO>>
* <<Étape 5 : activer SAML,Étape 5 : activer SAML>>
