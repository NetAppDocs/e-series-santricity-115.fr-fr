...
+
** Si votre volume d'instantanés est en lecture/écriture, la boîte de dialogue *capacité d'évaluation* s'affiche. Accédez à  3: Reserve capacity.
** Si votre volume de snapshot est en lecture seule, la boîte de dialogue *Modifier la priorité* apparaît. Accédez à  4: Edit settings.
...
. Cliquez sur *Suivant* et allez à  4: Edit settings.
