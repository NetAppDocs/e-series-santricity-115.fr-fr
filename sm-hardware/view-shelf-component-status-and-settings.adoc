...
+
La boîte de dialogue *Shelf Components Settings* s'ouvre, avec des onglets affichant l'état et les paramètres associés aux composants de la tablette. Selon le type d'étagère sélectionné, certains onglets décrits dans le tableau peuvent ne pas s'afficher.
