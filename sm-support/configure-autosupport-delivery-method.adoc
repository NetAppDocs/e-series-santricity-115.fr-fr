...
*** (Facultatif ; si vous souhaitez effectuer un test de configuration.) Adresse e-mail à laquelle une confirmation est envoyée lorsque le système AutoSupport reçoit l'intervention de test.
